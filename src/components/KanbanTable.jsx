...
import { getKanbanByCompany, editStatusKanban } from "../modules/fetch/kanban";
...
const KanbanTable = () => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            {selectedKanban && (
                <div className={`fixed top-0 left-0 right-0 z-50 ${modalOpen ? '' : 'hidden'} w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                    <div className="relative w-full max-w-4xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-5 md:p-10 space-y-4 flex justify-center items-start gap-10">
                            ...
                            <div className="flex items-center p-4 md:p-5 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
                                <button type="button" onClick={() => updateKanbanStatus(selectedKanban.id, "accepted")}
                                ...
                                <button type="button" onClick={() => updateKanbanStatus(selectedKanban.id, 'process')}
                                ...
                                <button type="button" onClick={() => updateKanbanStatus(selectedKanban.id, 'rejected')}
